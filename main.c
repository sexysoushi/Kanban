...
{	
	...
	//if(pthread_create(&t2, NULL, Step_thread_fct, 0) != 0) { error("Error Step thread creation\n"); exit(1);}
	//if(pthread_create(&t3, NULL, Finish_thread_fct, 0) != 0) { error("Error Finish thread creation\n"); exit(1);}
