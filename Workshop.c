...
{ 	
	...
	while(1)
	{
		...
		printf("supplier containerToSend->nbPieces = %d\n",supplier->containerToSend->nbPieces );		
		...
		if(supplier->containerToSend->nbPieces == nbPieceByContainer)
		{
			...
			list_insert(tmpWorkshop->stock.listContainer, (void*) supplier->containerToSend);		
	...
	{	
		...
		*/
		...
		if(workshop->containerToSend->nbPieces == nbPieceByContainer)
		{
			...
			list_insert(tmpWorkshop->stock.listContainer, (void*) workshop->containerToSend);
